...
# Встроенная функция str() возвращает объект в неформальном (понятном для человека) строковом представлении.
print(str(my_date))  # 2021-12-31
print(str(my_time))  # 11:20:54

# Встроенная функция repr() возвращает объект в формальном (понятном для интерпретатора) строковом представлении.
